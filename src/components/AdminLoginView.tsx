...
import { 
  ...
  BadgePercent, Eye, ShieldAlert, CheckCircle2, UserCheck, CreditCard
} from 'lucide-react';
...
export default function AdminLoginView({ 
 ...
 const handleClientLogin = (e: React.FormEvent) => {
    ...
    if (found) {
      ...
      setSuccessMsg(`¡Bienvenido de vuelta, ${found.fullname}! Tu pasaporte digital está listo.`);
      setClientEmail('');
            ...
            {activeTab === 'login' ? (
              ...
              <div className="space-y-5">
                ...
                <form onSubmit={handleClientLogin} className="space-y-4">
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        placeholder=""
                        className="w-full bg-zinc-950 border border-zinc-800 rounded px-3 py-3 pl-10 text-xs text-white focus:outline-none focus:border-amber-400 transition-colors"
                      />
                    </div>
                  </div>
                  ...
                  <button
                    type="submit"
                    className="w-full py-3.5 rounded bg-amber-400 hover:bg-amber-305 text-zinc-950 font-bold uppercase tracking-widest text-xs transition-colors duration-300 cursor-pointer"
                  >
                    Ingresar a Mi Panel
                  </button>
                </form>
              ...
              <div className="space-y-1 text-xs">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder=""
                    className="w-full bg-zinc-950 border border-zinc-800 rounded px-2.5 py-2 pl-9 text-xs text-white focus:outline-none focus:border-amber-400 transition-colors"
                  />
                </div>
              </div>
